...
{
    var word;
    const words=["arsenal", "chelsea", "manchestercity", "manchesterunited", 
                "tottenham", "liverpool", "brighton", "westham", "astonvilla",
                "wolves", "notthinghamforest", "bournemouth", "brentford", "newcastle",
                "burnley", "sheffieldunited", "fulham", "crystalpalace", "luton","everton"];
